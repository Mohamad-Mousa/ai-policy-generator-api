...
class IntergovernmentalOrganisationService extends BaseService {
  constructor() {
    super();
    this.IntergovernmentalOrganisation = this.models.IntergovernmentalOrganisation;
  }
  ...
  async findMany(req_query, limit = 10) {
    ...
    const [result] = await this.IntergovernmentalOrganisation.aggregate(pipeline);
...
module.exports = IntergovernmentalOrganisationService;
